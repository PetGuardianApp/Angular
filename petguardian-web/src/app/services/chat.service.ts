...
export class ChatService {
  ...
  private pollForMessages(uid: string) {
    ...
    this.http.get(this.apiUrl + "vet/get/" + uid + "/message", { responseType: 'text' })
  ...
  public sendMessage(uid:string, message:string) {
    ...
    return new Promise((resolve, reject) => {
      this.http.put(this.apiUrl + 'vet/add/' + uid + "/message", message, { headers: headers })
        .subscribe(
          (response) => {
            resolve(response);
          },
  ...
  private removeMessage(uid:string) {
    ...
    return new Promise((resolve, reject) => {
      this.http.put(this.apiUrl + 'vet/update/' + uid + "/message", { headers: headers })
        .subscribe(
          (response) => {
            resolve(response);
          },
